                        ...
                        <div class="card p-2">
                            ...
                            <div class="card-body">
                                @foreach ($newPosts as $post)
                                    <a
                                        href="{{ route('communities.posts.show', [$post->community, $post]) }}">{{ $post->title }}</a>
                                    <p>{{ $post->created_at->diffForHumans() }}</p>
                                    @can('view', $post)
                                        <span class="btn btn-sm btn-success">Owner</span>
                                    @endcan
                                    <hr>
                                @endforeach
                            </div>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                @foreach ($newCommunities as $community)
                                    <a
                                        href="{{ route('communities.show', $community) }}">{{ $community->name }}</a><span>

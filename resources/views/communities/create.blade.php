                ...
                <div class="card-body">
                    ...
                    <form action="{{route('communities.store')}}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" type="textarea" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('dscription') }}" required autocomplete="dscription" autofocus></textarea>
